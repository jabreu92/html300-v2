...
const container = document.querySelector('.template-hook');
    ...
    let personsHTML = persons.map(function(el) {
        //Loop all coding languages and store it
        let languages = [];
        el.codeLanguages.forEach(element => languages.push(element));
        //String template
        ...
        <div class="employee-card-right">
           <div class="employee-card-right___info">
              ...
              <p> <strong> Languages: </strong>${languages.toString()}</p>
